<div class="col-sm-3 sidenav hidden-xs">
  <br><a href="#"><img class="img-responsive" src="{{ URL::to('/anh/anh-website/logo.png') }}" alt="Logo" style="margin: auto;"></a><br>
  <div class="text-center">
    <img src="{{ URL::to('/anh/anh-thanh-vien/img_avatar1.png') }}" class="img-responsive img-circle" alt="anh dai dien" style="width:40%; margin:auto;"><br>
  ...
  <ul class="nav nav-pills nav-stacked">
    ...
    <li class="dropdown">
      ...
      <span class="caret"></span></a>
      <ul class="dropdown-menu">
        <li><a href="{{ route('admin.hang-san-xuat.danh-sach-hang-san-xuat') }}">Danh sách hãng sản xuất</a></li>
        <li><a href="{{ route('admin.hang-san-xuat.them-hang-san-xuat') }}">Thêm hãng sản xuất</a></li>
      </ul>
    </li>
    <li class="dropdown">
